...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void acceptRequest(View view) {
            ...
            query.whereEqualTo("username", intent.getStringArrayExtra("username"));
                    ...
                    if (e == null){
                        if (objects.size() > 0) {
                            for (ParseObject object : objects) {
                                object.put("driveUsername", ParseUser.getCurrentUser().getUsername());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                LatLng driverLocation = new LatLng(intent.getDoubleExtra("driverLatitude", 0), intent.getDoubleExtra("driverLogitude", 0));
